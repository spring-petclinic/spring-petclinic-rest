...
public class PetRestControllerTests {
    ...
    public void testGetPetSuccess() throws Exception {
        given(this.petService.findPetById(3)).willReturn(Optional.ofNullable(pets.get(0)));
    ...
    public void testGetPetNotFound() throws Exception {
        given(this.petService.findPetById(-1)).willReturn(Optional.empty());
    ...
    public void testGetAllPetsSuccess() throws Exception {
        given(this.petService.findAllPets()).willReturn(pets);
