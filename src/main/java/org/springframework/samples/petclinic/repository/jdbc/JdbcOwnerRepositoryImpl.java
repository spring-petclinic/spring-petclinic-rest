...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
    ...
    public void loadPetsAndVisits(final Owner owner) {
        ...
        final List<JdbcPet> pets = this.namedParameterJdbcTemplate.query(
            "SELECT pets.id as pets_id, name, birth_date, type_id, owner_id, visits.id as visit_id, visit_date, description, cancelled, cancellation_reason, visits.pet_id as visits_pet_id FROM pets LEFT OUTER JOIN visits ON pets.id = visits.pet_id WHERE owner_id=:id ORDER BY pets.id",
            params,
