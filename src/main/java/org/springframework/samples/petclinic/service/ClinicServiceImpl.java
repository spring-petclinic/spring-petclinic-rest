...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "visits", key = "#visitId", unless = "#result == null")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "vets", key = "#id", unless = "#result == null")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "petTypes", key = "#petTypeId", unless = "#result == null")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "specialties", key = "#specialtyId", unless = "#result == null")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "petTypes", key = "'distinct'")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "vets", key = "'findVets'")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "owners", key = "'lastName:' + #lastName", unless = "#result == null or #result.isEmpty()")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "visits", key = "'petId:' + #petId", unless = "#result == null or #result.isEmpty()")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "specialties", key = "'names:' + #names.toString()", unless = "#result == null or #result.isEmpty()")
