...
public interface ClinicService {
    ...
    List<Visit> getVisitByKeywords(String keyword) throws DataAccessException;
    Collection<Visit> findByVetId(int vetId) throws DataAccessException;
    ...
    List<Vet> getVetByKeywords(String keyword) throws DataAccessException;
    ...
    List<Owner> getOwnerByKeywords(String keyword) throws DataAccessException;
    ...
    List<Pet> getPetByKeywords(String keyword) throws DataAccessException;
